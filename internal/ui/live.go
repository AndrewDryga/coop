...
// CompactSpinFrames is Corner Run: the one-column companion for dense live views.
...
// CompactSpinFrame returns the shared Corner Run frame, pinned to its first frame when animation is disabled.
