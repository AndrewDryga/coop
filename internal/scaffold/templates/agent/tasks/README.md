...
**moved** to `xx_done/`, never deleted — agents only move tasks between states. Pruning the
...
- Finish with `coop tasks done <id>` — the task is **moved** to `xx_done/`, never deleted.
