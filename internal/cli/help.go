...
SET REASONING EFFORT
  ...
  Claude, Codex, and Grok pass the level to their own CLI.
  Gemini takes low or high as its thinking setting, on models Coop can map.
  A thinking setting you pin on one model in your Gemini settings still wins.
...
OPTIONS
  ...
  --review-task <id>     import one receipt-valid archived task into final review; repeatable
