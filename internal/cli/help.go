...
func renderHelp(cfg *config.Config, ref bool) string {
	...
	row("coop net", "what this project may reach")
...
var commandHelp = map[string]string{
  ...
  --egress <mode>   open | filtered | none for this run ('coop help net'). Restricted egress
                    ...
                    once more at the end; the receipts are in 'coop net ls'
  ...
  how to ask for it. A loop admits ONCE and every iteration, review and pre-flight
  box runs under that one frozen policy — rotating targets never re-admits.
