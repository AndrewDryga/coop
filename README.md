...
| `COOP_SPINNER` | `1` | animate live-view Box Run spinners. `0`/`false` freezes them and suppresses the loop's fast repaint ticker, useful for debugging and terminal recording |
