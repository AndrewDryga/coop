...
check: "go test ./internal/sessionsvc -run 'TestInvalidStructuredResultIsRepairedBeforeTheTurnCompletes|TestRepeatedInvalidStructuredResultNeverCompletes|TestSchemaValidSemanticResultWaitsForCallerAcceptance|TestRejectedSemanticResultRepromptsTheSameNativeTurn'"
updated: 2026-08-25
---
...
operation. Rejections are visible as events, resume the same logical/native turn, and share the
three-candidate bound with schema repairs. A restart preserves the candidate; acceptance returns a
durable receipt.
