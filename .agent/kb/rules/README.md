...
- [read-a-mutation-result-whole](read-a-mutation-result-whole.md) — a state-changing command's result is read whole, or its effect checked, before it is ever re-run
