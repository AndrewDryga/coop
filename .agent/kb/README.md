...
- [fork-lifecycle-state-file](fork-lifecycle-state-file.md) — one owner-v1 pidfile holds four fork lifecycle states; unsupported formats stay held, and only pid+start-token (never file age) may declare a current owner gone
